		...
		?>
			<section class="main">
				<form class="form-4" action="login.php" method ="POST" >
				    ...
				    <p>
				        Username
				        <input type="text" class="form-control" name="Username" placeholder="eg:Yagnik" required>
				    </p>
				    <p>
				        Password
				        <input type="password" class="form-control" name='Password' placeholder="eg:Yagnik123" required>
				    </p>
